...
EXAMPLE_LIST_OF_CONCEPTS = [ ['The Path to the Internet', "We interact with the internet through our computer and browser. The browser is a program that displays files on the web, intepreting them to show us what we see. The internet is essentially the world's largest computer, pulling files from servers though HTTP from the servers. Servers are essentially large computers that hold the files that make up the internet and sends them though the internet to our computers."],
            ...
            There are five types of files on the web: <em> plain text, HTML, images, videos, and music </em>. HTML allows for hyperlinks, making the web \"web-like\" """],
                             ["What makes up HTML?", """HTML is made up of four elements. What you see is referred to as the text content. How the text content is displayed to you is the mark up. Links to other pages or reference to other documents like images and videos are how it helps the interneThis was well-explained <a href="https://www.udacity.com/course/viewer#!/c-ud721/l-3508959201/m-48724340"> here </a>. </p> <p> A HTML markup was made up of the name of the tag, the content of the tag, and the end of the tag. This is explained in this <a href="https://www.udacity.com/course/viewer#!/c-ud721/l-3508959201/m-48723444"> video. </a> """],
